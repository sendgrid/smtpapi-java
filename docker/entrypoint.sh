...
if [ -d /mnt/smtpapi-java ]
then
	rm /root/sendgrid
	ln -s /mnt/smtpapi-java/sendgrid
	echo "Linked mounted smtpapi-java's code to /root/sendgrid"
fi

SENDGRID_JAVA_VERSION="1.0.0"
echo "Welcome to smtpapi-java docker v${SENDGRID_JAVA_VERSION}."
echo
